...
public final class EmailService {
    ...
    private static String buildHtmlBody(String groupName, String apparatusName, int qty, String newStatus) {
        ...
        return "<!doctype html>"
                ...
                + "    <p style='margin:0 0 14px 0;'>Your borrowing request status has been updated:</p>"
                ...
                + "    <p style='margin:0; font-size: 12px; color:#777;'>This is an automated message from the ChemLab System.</p>"
                + "  </div>"
                + "</div>"
                + "</body></html>";
    }
